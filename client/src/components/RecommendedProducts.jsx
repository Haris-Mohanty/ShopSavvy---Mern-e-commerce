  ...
  return (
    <>
      <div className="container mx-auto px-4 md:pl-8 my-6">
        <h2 className="font-bold text-3xl py-3 text-gray-800 mb-2">
          {heading}
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
          ...
          {loading
            ? Array.from({ length: 8 }).map((_, index) => (
                <div
                  key={index}
                  className="relative flex-none w-80 max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md"
                >
